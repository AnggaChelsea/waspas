                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Daftar Penerima Bantuan</h5>
                                        </div>
                                            ...
                                            <table id="example4" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="background-color: #2ed88a; color:#ffffff;">NIk</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data_penduduk_hasil as $hasil) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $this->Mpenduduk->get_data_penduduk_id($hasil['id_penduduk'])['nik'] ?></td>
