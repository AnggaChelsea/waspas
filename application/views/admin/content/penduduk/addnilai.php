                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Nik Penduduk</label>
                                                    <select id="id_penduduk" name="id_penduduk" class="form-control select2" required="">
                                                        ...
                                                        foreach ($data_penduduk as $pdk) {
                                                            if (in_array($pdk['id_penduduk'], $arNilaii)) {
                                                                ...
                                                                echo '<option value="' . $pdk['id_penduduk'] . '">' .  $pdk['nik'] .  '</option>';
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="kriteria[]" class="form-control select2" required="">
                                                            ...
                                                            foreach ($this->Mdatakriteria->get_data_nilai_kriteria($key['id_kriteria']) as $kriteria) {
                                                                echo '<option value="' . $kriteria['id_nilai_kriteria'] . '">' . $kriteria['pilihan'] . '</option>';
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
